...
@implementation NSObject (MXSwizzle)

+ (void)mx_swizzleSelector:(SEL)originalSelector withLocalSelector:(SEL)localSelector {
...
+ (void)mx_swizzleSuperclassSelector:(SEL)superclassSelector withLocalSelector:(SEL)localSelector {
    ...
    else [self mx_swizzleSelector:superclassSelector withLocalSelector:localSelector];
}
