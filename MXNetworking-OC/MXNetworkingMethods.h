...
typedef void (^FullResponseCallback)(ResponseStatus status, id responseObject, NSError *error);

typedef void (^MXNetworkingRequestCompletion)(ResponseStatus status, NSData *responseData, NSError *error);
